...
var data='&r='+escape(document.referrer.substr(0,512))+'&lg='+escape(navigator.systemLanguage)+'&ntime=0.96389900 1243660809';
...
if(eid==-1) eid=Math.floor(Math.random()*100000000)+"-"+1243660809+"-"+document.referrer.substr(0,64);
...
document.write('<a href="http://www.cnzz.com/stat/website.php?web_id=1238406" target=_blank title="站长统计">站长统计</a>');
