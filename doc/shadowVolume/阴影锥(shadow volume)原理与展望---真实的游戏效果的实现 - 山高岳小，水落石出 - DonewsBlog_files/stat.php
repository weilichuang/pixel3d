...
var data='&r='+escape(document.referrer.substr(0,512))+'&lg='+escape(navigator.systemLanguage)+'&ntime=0.33815400 1243661030';
var cnzz_a=gc_cnzz("cnzz_a149443");
...
document.write('<a href="http://www.cnzz.com/stat/website.php?web_id=149443" target=_blank title="Õ¾³¤Í³¼Æ"><img border=0 hspace=0 vspace=0 src="http://icon.cnzz.com/pic.gif" ></a>');
document.write('<img src="http://b76.cnzz.com/stat.htm?id=149443'+data+'" border=0 width=0 height=0>');
var et=(86400-ed.getHours()*3600-ed.getMinutes()*60-ed.getSeconds());
ed.setTime(now+1000*(et-ed.getTimezoneOffset()*60));
document.cookie="cnzz_a149443="+cnzz_a+";expires="+ed.toGMTString()+ "; path=/";
document.cookie="vw149443="+escape(vw)+ ";expires="+ed.toGMTString()+";path=/";
document.cookie="sin149443="+escape(sin)+ ";expires="+ed.toGMTString()+";path=/";
