...
class MathUtil
{
	...
	public static var Reciprocal255 : Float = 1.0 / 255.0;
	...
	public static var POSITIVE_INFINITY : Float = untyped __global__["Number"].POSITIVE_INFINITY;
	public static var NEGATIVE_INFINITY : Float = untyped __global__["Number"].NEGATIVE_INFINITY;
