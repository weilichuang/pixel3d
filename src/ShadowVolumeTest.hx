...
class ShadowVolumeTest extends Test
{
	...
	public function new()
	{
		...
		light = new LightNode(0xffff00, 1000., Light.POINT);
	...
	private function initSceneNode():Void
	{
		...
		var box1:CubeNode = new CubeNode(100, 200, 100);
		...
		var box2:CubeNode = new CubeNode(100, 200, 100);
		...
		var node3:PlaneNode = new PlaneNode(600, 600, 1, 1);
		node3.setMaterialEmissiveColor(0x770000);
		node3.rotationX = -90;
		manager.addChild(node3);

		var node4:PlaneNode = new PlaneNode(600, 400, 1, 1);
		...
		var node5:PlaneNode = new PlaneNode(600, 400, 1, 1);
		...
		var node6:PlaneNode = new PlaneNode(600, 400, 1, 1);
		...
		var node7:PlaneNode = new PlaneNode(600, 400, 1, 1);
		...
		var cube:CubeNode = new CubeNode(20, 20, 20);
